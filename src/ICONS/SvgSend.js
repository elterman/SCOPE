import { GOLD, WHITE } from '../const';

const Icon = ({ style = {}, disabled = false, width, color = GOLD, viewBox = '0 0 495.003 495.003' }) => {
  return (
    <svg style={{ ...style, display: 'block' }} width={width} height={width} viewBox={viewBox} xmlns="http://www.w3.org/2000/svg">
      ...
      <g opacity={disabled ? 0.23 : 1} fill={disabled ? WHITE : color}>
